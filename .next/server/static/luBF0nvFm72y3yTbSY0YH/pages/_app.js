...
// CONCATENATED MODULE: ./src/lib/isBrowser.ts
var isBrowser = false;
// CONCATENATED MODULE: ./src/lib/init-apollo.ts
...
function initApollo(initialState, options) {
  ...
  if (!init_apollo_apolloClient) {
    init_apollo_apolloClient = create(initialState, options);
  }

  return init_apollo_apolloClient;
}
// CONCATENATED MODULE: ./src/lib/with-apollo-client.tsx
...
/* harmony default export */ var with_apollo_client = (function (App) {
  ...
  function (_React$Component) {
    ...
    return WithData;
  }(external_react_default.a.Component), _defineProperty(_class, "displayName", "WithData(".concat(App.displayName, ")")), _temp;
});
...
// CONCATENATED MODULE: ./src/store/reducers/theme.reducer.ts
...
var theme_reducer_themeReducer = function themeReducer() {
  ...
  switch (action.type) {
    ...
    case theme_types["b" /* UPDATE_SELECTED_THEME */]:
      return _objectSpread({}, state, {
...
/* harmony default export */ var theme_reducer = (theme_reducer_themeReducer);
...
var composeEnhancers = Object(external_redux_devtools_extension_["composeWithDevTools"])({}); // Determine if devtools need to be present, based on the node environment

var loadMiddleware;

if (false) {} else {
  loadMiddleware = Object(external_redux_["compose"])(external_redux_["applyMiddleware"].apply(void 0, middleware));
}

/* harmony default export */ var src_store = (function () {
  return Object(external_redux_["createStore"])(reducers, loadMiddleware);
});
...
var _app_MyApp = function MyApp(props) {
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (with_apollo_client(external_next_redux_wrapper_default()(src_store)(_app_MyApp)));
