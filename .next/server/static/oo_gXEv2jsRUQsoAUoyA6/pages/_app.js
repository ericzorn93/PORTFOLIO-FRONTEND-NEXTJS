    ...
    static async getInitialProps(ctx) {
      ...
      if (!isBrowser) {
        ...
        try {
          ...
          await Object(external_react_apollo_["getDataFromTree"])(external_react_default.a.createElement(App, _extends({}, appProps, {
            Component: Component,
            router: router,
            apolloClient: apollo
          })));
...
/* harmony default export */ var theme_reducer = (themeReducer);
...
const composeEnhancers = Object(external_redux_devtools_extension_["composeWithDevTools"])({}); // Determine if devtools need to be present, based on the node environment

let loadMiddleware;

if (false) {} else {
  loadMiddleware = Object(external_redux_["compose"])(Object(external_redux_["applyMiddleware"])(...middleware));
}

/* harmony default export */ var src_store = (() => Object(external_redux_["createStore"])(reducers, loadMiddleware));
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (with_apollo_client(external_next_redux_wrapper_default()(src_store)(MyApp)));
